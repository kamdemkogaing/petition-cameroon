  ...
  return (
    ...
    >
      <div className="relative flex min-h-[460px] items-center px-6 py-10 md:px-10 md:py-14">
        <div className="absolute inset-0 bg-[url('/maurice-kamto.jpg')] bg-no-repeat bg-[92%_center] bg-[length:auto_105%] opacity-40 md:bg-[88%_center] md:bg-[length:auto_118%]" />
